            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                ...
                <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                  Get in touch with our engineering team to learn how our precision CNC services 
                  can accelerate your product development and streamline your manufacturing process.
                </p>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm sm:text-base text-white font-semibold">vibhanshu@vignam.in</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <div className="text-sm sm:text-base text-gray-300">Location</div>
                      <div className="text-sm sm:text-base text-white font-semibold">Global - Remote First</div>
                    </div>
                  </div>
              ...
              >
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Send Message
                  </motion.button>
                </form>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">
                  Revolutionizing manufacturing through precision CNC machining, 
                  rapid prototyping, and automated production systems.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><a href="#" className="hover:text-white transition-colors">Custom Parts</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li><a href="#" className="hover:text-white transition-colors">Aluminum</a></li>
                  <li><a href="#" className="hover:text-white transition-colors">Steel</a></li>
            ...
            <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 mb-4 md:mb-0">
                © 2025 FORGE Manufacturing. All rights reserved.
              </div>
